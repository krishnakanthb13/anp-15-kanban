...
- **Card Menu & Triage**: Edit full details modal, mark completed / reopen, labels, start/due dates, snooze, and new note creation.
...
- **Toolbar Toggles**: Evenly distributed card detail inspection (`Info`), quick `@ Date` mode, density switching, and empty column visibility.
