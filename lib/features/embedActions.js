...
/**
 * Adds a new tab via a prompt with 3 clear choices:
 * 1. Note board (Existing Note)
 * 2. Create new Note Board (auto-creates under -reports/-kanban)
 * 3. Tag board (Notes under tag as columns with collapsible headings)
 * @param {Object} app
 */
